...
label.pack(side=TOP)
filename = PhotoImage(file="D1.png")
...
# but2=Button(frame,padx=5,pady=5,width=39,bg='white',fg='black',relief=RAISED,command=webrec,text='Open Cam & Record',font=('helvetica 15 bold'))
